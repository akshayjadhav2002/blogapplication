package com.example.myblogapplication.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,String>> handelMethodArgsNoValidException(MethodArgumentNotValidException ex){
